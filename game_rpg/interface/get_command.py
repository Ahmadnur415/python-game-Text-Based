...
def get_command(commands: list, name_command: str = "", list_option: bool = False,
                add_command_back: bool = True, loop: bool = True) -> tuple | bool:
    ...
    while True:
        ...
        if list_option:
            ...
            leftprint(
                *generate_readable_list(lines, number=True, make_line=False), distance=1
            )
